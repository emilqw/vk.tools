//
//  ModelErrorMessageList.swift
//  VK Tools
//
//  Created by Эмиль Яйлаев on 19.11.2021.
//

import Foundation
struct ErrorMessageList {
    public static let errorList:[Int:[String]] = [
        ...
        34:["Версия клиента устарела."],
        37:["Пользователь был забанен."],
        38:["Неизвестное приложение."],
        39:["Неизвестный пользователь."],
        40:["Неизвестная группа."],
        41:["Требуется дополнительная регистрация."],
        42:["IP-адрес не разрешен."],
        ...
        1114:["Срок действия анонимного токена истек."],
        1116:["Анонимный токен недействителен."],
        3300:["Требуется повторная запись."],
        3301:["Требуется проверка телефона."],
        3302:["Требуется проверка пароля."],
        3303:["Требуется проверка приложения Otp."],
        3304:["Требуется подтверждение по электронной почте."],
        3305:["Утверждать голоса."],
        3609:["Требуется расширение токена."],
        3610:["Пользователь деактивирован."],
        3611:["Услуга отключена для пользователя."],
    ]
}
